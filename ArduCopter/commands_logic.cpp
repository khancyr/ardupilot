...
bool Copter::verify_payload_place()
{
    ...
    case PayloadPlaceStateType_Descending_Start:
        ...
        nav_payload_place.descend_start_altitude = ahrs.get_altitude();
    ...
    case PayloadPlaceStateType_Descending:
        ...
        debug("descended: %f cm (%f cm max)", (nav_payload_place.descend_start_altitude - ahrs.get_altitude()), nav_payload_place.descend_max);
        if (!is_zero(nav_payload_place.descend_max) &&
            nav_payload_place.descend_start_altitude - ahrs.get_altitude()  > nav_payload_place.descend_max) {
