...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Values: 0:None,1:VectorNav,2:MicroStrain5,5:InertialLabs,7:MicroStrain7,11:EulerNav
    // @User: Standard
...
void AP_ExternalAHRS::init(void)
{
    ...
    case DevType::EulerNav:
        backend = new AP_ExternalAHRS_EulerNav(this, state);
        return;
#endif
