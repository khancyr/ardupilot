...
#            raise NotAchievedException("Extra parameters in XML")
    ...
    def wait_altitude(self, altitude, accuracy, relative=False, maintain_target_time=None, timeout=30, called_function=None):
        """Wait for a given altitude range."""
        def get_altitude(relative=False, timeout2=30):
        ...
        self.wait_and_maintain("Altitude", altitude, lambda: get_altitude(relative, timeout), accuracy=accuracy, maintain_target_time=maintain_target_time, timeout=timeout, called_function=called_function)

    def wait_groundspeed(self, groundspeed, accuracy, maintain_target_time=None, timeout=30):
        ...
        self.wait_and_maintain("Groundspeed", groundspeed, lambda: get_groundspeed(timeout), accuracy=accuracy, maintain_target_time=maintain_target_time, timeout=timeout)
    ...
    def wait_roll(self, roll, accuracy, timeout=30):
        ...
        self.wait_and_maintain("Roll", roll, lambda: get_roll(timeout), accuracy=accuracy, timeout=timeout)
    ...
    def wait_pitch(self, pitch, accuracy, timeout=30):
        ...
        self.wait_and_maintain("Pitch", pitch, lambda: get_pitch(timeout), accuracy=accuracy, timeout=timeout)
    ...
    def wait_heading(self, heading, accuracy=5, maintain_target_time=None, timeout=30):
        ...
        self.wait_and_maintain("Heading", heading, target_retreiver=lambda: get_heading_wrapped(heading, timeout), validator=lambda value2, target2: validator(value2, target2), accuracy=accuracy, maintain_target_time=maintain_target_time, timeout=timeout)
